<div class="lg:fixed bottom-0 w-full">
	@include('navigation.org_flash')
	<footer class="flex flex-col lg:flex-row bg-base-300 justify-between w-full text-xs font-mono items-center">
		<div class="dropdown dropdown-top">
			...
			<ul tabindex="0" class="dropdown-content bg-base-200 menu z-1 w-52 p-0 border border-base-300 border-solid">
