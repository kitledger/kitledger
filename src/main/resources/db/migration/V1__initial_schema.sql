...
ALTER TABLE "permission_assignments" ADD CONSTRAINT "permission_assignments_permission_id_permissions_id_fk" FOREIGN KEY ("permission_id") REFERENCES "permissions"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "system_permissions" ADD CONSTRAINT "system_permissions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE no action ON UPDATE no action;
